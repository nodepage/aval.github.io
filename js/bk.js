...
window.addEventListener("load", function () {
  ...
  if (param1 == null || localStorage.getItem(param1) === null) {
    ...
    function updateUx(
      ...
      reflinkz.innerHTML = `https://farm.playavalons.com/?referral=${referralId}`;

      var copyText = document.getElementById("Inputref");
      copyText.value = `https://farm.playavalons.com/?referral=${referralId}`;
